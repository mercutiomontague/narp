...
Feature: Parse the definition for an input file
  ...
  Scenario: Providing a filename with spaces
    ...
    And the filename hash is my text file.txt_e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 
    Given an input /infile 'short/path/to/My text file.txt'
    When parsed by InfileG
    And the original filename is short/path/to/My text file.txt
    And the filename hash is My text file.txt_5c05562579fb70adfe12e2902c3af23506b02ecfa59cd565fddc1d83aa90f241 
		Given an existing app that is reinitialized with zions domain
    And an input /infile 'short/path/to/Your text file.txt'
    When parsed by InfileG
    And the filename hash is Your text file.txt_3e37a3168e671b9668a08c5c421a204118095218f3ed1b490bd690879c27c6e8 
  ...
  Scenario Outline: Providing a filename, an organization and compression
    ...
    And the original filename is path/to/inputfile/My text_file.txt
...
##### can also be applied to outfile
  ...
  Scenario: Providing the another set of options 
    ...
    When parsed by InfileG
    Then I have a Infile at the root
    And the original filename is /etlsource/text_253_2016-09-23.txt
