...
module Narp
  class NarpApp < OpenStruct
    ...
    def postprocess
      ...
      outfiles.collect{|o| ["#!/bin/bash\n", o.init_post, o.move_hdfs2post_stage, o.post_process, o.move_post2s3, "\n"].join("\n") }.join("\n")
    end
    ...
    def cleanup
      [infiles, outfiles].flatten.collect{|o| o.cleanup}.join("\n")
		...
		def generate_json_output
			::JSON.generate( {:preprocess => preprocess, :ddl => ddl, 
										 		:hql => hql, :postprocess => postprocess, 
